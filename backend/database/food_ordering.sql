-- ==============================================================
-- Quick Bite Restaurant Ordering System - Database Schema
...
-- Compute order_items.subtotal automatically on INSERT
...
-- Re-aggregate orders.total_amount after INSERT on order_items
...
-- Re-aggregate orders.total_amount after UPDATE
...
-- Re-aggregate orders.total_amount after DELETE

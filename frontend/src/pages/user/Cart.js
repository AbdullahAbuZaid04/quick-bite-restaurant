    ...
    <div className="min-h-screen bg-ui-mainBg">
      ...
      <main className="max-w-4xl mx-auto px-4 md:px-6 py-8 md:py-12">
        <section className="flex items-center gap-4 mb-8">
          <button className="p-2 bg-ui-white rounded-xl border border-ui-border hover:bg-brand-primary transition-all duration-300 group">
              ...
              <div key={item.id} className="group relative flex items-center gap-4 p-4 rounded-2xl bg-ui-white border border-ui-border hover:border-brand-primary/50 transition-all">
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-start">
                    ...
                    <button className="text-content-subtitle hover:text-red-500 transition-colors duration-200 p-1">
                      <Trash2 size={18} />
                    </button>
                  </div>
                  ...
                  <div className="flex justify-between items-center mt-auto">
                    <div className="flex items-center gap-3 bg-ui-mainBg border border-ui-border rounded-xl p-1">
                      <button className="w-7 h-7 flex items-center justify-center bg-ui-white rounded-lg border border-ui-border text-content-paragraph hover:bg-brand-primary hover:text-ui-white transition-all cursor-pointer duration-300">
                        <Minus size={14} />
                      </button>
            ...
            <div className="sticky top-24 bg-ui-white border border-ui-border rounded-2xl p-8">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex justify-between text-sm">
                  <span className="text-content-subtitle">Subtotal</span>
                  <span className="font-bold text-content-paragraph">${subtotal.toFixed(2)}</span>
                </div>
                <div className="pt-4 border-t border-ui-mainBg flex justify-between items-end">
                  <div>
                    ...
                    <p className="text-4xl font-black text-content-paragraph">${(subtotal).toFixed(2)}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-4 bg-ui-mainBg rounded-2xl mb-8 border border-ui-border/50">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-content-paragraph">25 - 35 Minutes</p>
                </div>
              </div>

              <button className="w-full bg-brand-primary text-ui-white py-5 rounded-2xl font-bold text-lg flex items-center justify-center gap-3 hover:bg-brand-hover transition-all active:scale-95 group">
                Checkout Now
